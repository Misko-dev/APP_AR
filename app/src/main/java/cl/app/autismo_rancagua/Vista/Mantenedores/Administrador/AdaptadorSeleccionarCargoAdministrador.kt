...
class AdaptadorSeleccionarCargoAdministrador(
    private val listaCargo: ArrayList<CargoAdministrador>,
    private var activity: Activity,
    private var context: Context


) : RecyclerView.Adapter<AdaptadorSeleccionarCargoAdministrador.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val ID_CARGO_ADMINISTRADOR = cargo.ID_CARGO_ADMINISTRADOR
