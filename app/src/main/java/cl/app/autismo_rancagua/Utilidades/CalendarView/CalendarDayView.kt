...
class CalendarDayView : AppCompatTextView {
    ...
    private var mPortionColor =
        DEFAULT_COLOR
    private var mPortionWidth =
        DEFAULT_PORTION_WIDTH
    ...
    override fun setSelected(selected: Boolean) {
        when {
            selected -> setTextColorResource(R.color.blanco)
            isCurrentMonth -> setTextColorResource(R.color.colorAccent)
            else -> setTextColorResource(R.color.colorAccent)
        }
    ...
    private fun drawCenterCircle(canvas: Canvas?) {
        ...
        context?.let { context ->
            if (mIsSelected) {
                mPaint.color = context.getThemePrimaryColor()
            } else {
                mPaint.color = Color.WHITE
            }
    ...
    private fun drawCurrentDayCircle(canvas: Canvas?) {
       ...
       /* mPaint.color = context.getThemeAccentColor()*/
        mPaint.style = Paint.Style.FILL
        mPaint.strokeWidth =
            DEFAULT_CURRENT_DAY_CIRCLE_WIDTH
